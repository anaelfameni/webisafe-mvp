...
const FAQ = [
  ...
  { q: 'Le scan mensuel remplace-t-il mon audit manuel ?', a: 'Il est identique en profondeur. Si vous voulez scanner votre site à la demande en plus, vous pouvez toujours lancer un scan gratuit depuis l\'accueil.' },
      ...
      <div className="min-h-screen px-4 pt-28 pb-16 flex items-center justify-center">
        <motion.div initial={{ opacity: 0, scale: 0.92, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} transition={{ type: 'spring', stiffness: 220, damping: 20 }}
          ...
          <p className="text-white/60 text-sm mb-6 leading-relaxed">
            Votre demande d'abonnement <strong className="text-white">Webisafe Protect Basic</strong> a bien été enregistrée.<br />
            Notre équipe valide votre paiement Wave sous <strong className="text-white">2h ouvrées</strong> et active immédiatement votre surveillance.
          </p>
      ...
      <div className="max-w-6xl mx-auto pt-28 pb-16 text-center">
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <p className="text-white/50 text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
            ...
            <em className="text-white/70 not-italic font-medium">"Mon site est-il encore OK ce mois-ci ?"</em>
          </p>
