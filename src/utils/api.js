...
const FAULT_DIFFICULTY_MAP = {
  ssl_expired: 'Niv. 1 — Facile, sans développeur',
  ssl_misconfigured: 'Niv. 2 — Intermédiaire, accès hébergeur',
  hsts_missing: 'Niv. 3 — Technique, modification serveur',
  csp_missing: 'Niv. 3 — Technique, connaissance HTTP',
  xframe_missing: 'Niv. 2 — Intermédiaire, accès hébergeur',
  xcontent_missing: 'Niv. 2 — Intermédiaire, accès hébergeur',
  mixed_content: 'Niv. 2 — Intermédiaire, inspection du code',
  images_unoptimized: 'Niv. 1 — Facile, sans développeur',
  cache_missing: 'Niv. 2 — Intermédiaire, plugin ou config',
  gzip_disabled: 'Niv. 2 — Intermédiaire, accès hébergeur',
  js_render_blocking: 'Niv. 3 — Technique, JavaScript requis',
  css_render_blocking: 'Niv. 3 — Technique, CSS requis',
  meta_title_missing: 'Niv. 1 — Facile, sans développeur',
  meta_description_missing: 'Niv. 1 — Facile, sans développeur',
  h1_missing: 'Niv. 1 — Facile, sans développeur',
  alt_missing: 'Niv. 1 — Facile, sans développeur',
  sitemap_missing: 'Niv. 1 — Facile, plugin ou outil en ligne',
  robots_missing: 'Niv. 2 — Intermédiaire, accès FTP',
  xss_vulnerability: 'Niv. 4 — Expert, développeur senior',
  sql_injection: 'Niv. 4 — Expert, développeur senior',
  wordpress_outdated: 'Niv. 1 — Facile, sans développeur',
  plugin_outdated: 'Niv. 1 — Facile, sans développeur',
  no_https_redirect: 'Niv. 2 — Intermédiaire, accès hébergeur',
  mobile_not_responsive: 'Niv. 4 — Expert, développeur requis',
  malware: 'Niv. 4 — Expert, professionnel requis',
  https_missing: 'Niv. 2 — Intermédiaire, accès hébergeur',
  headers_missing: 'Niv. 2 — Intermédiaire, config serveur',
  sensitive_files: 'Niv. 2 — Intermédiaire, config serveur',
  lcp_slow: 'Niv. 3 — Technique, optimisation images/code',
  cls_unstable: 'Niv. 2 — Intermédiaire — Définir dimensions fixes',
  page_weight_heavy: 'Niv. 2 — Intermédiaire — Compression images et code',
  open_graph_missing: 'Niv. 1 — Facile — Plugin SEO ou ajout manuel',
