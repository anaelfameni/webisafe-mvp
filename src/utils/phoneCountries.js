export const DEFAULT_PHONE_COUNTRY = 'CI';

const COUNTRY_DIAL_CODES_RAW = [
  ...
  { code: 'MM', name: 'Birmanie', dialCode: '+95' },
  ...
  { code: 'DM', name: 'Dominique', dialCode: '+1' },
  ...
  { code: 'MH', name: 'Marshall', dialCode: '+692' },
  ...
  { code: 'SB', name: 'Salomon', dialCode: '+677' },
  ...
  { code: 'VI', name: 'Îles Vierges américaines', dialCode: '+1' },
  { code: 'AS', name: 'Samoa américaines', dialCode: '+1' },
  { code: 'MP', name: 'Îles Mariannes du Nord', dialCode: '+1' },
  ...
  { code: 'KY', name: 'Îles Caïmans', dialCode: '+1' },
  { code: 'BM', name: 'Bermudes', dialCode: '+1' },
  { code: 'AW', name: 'Aruba', dialCode: '+297' },
  { code: 'CW', name: 'Curaçao', dialCode: '+599' },
  { code: 'SX', name: 'Saint-Martin (partie néerlandaise)', dialCode: '+1' },
  ...
  { code: 'VG', name: 'Îles Vierges britanniques', dialCode: '+1' },
  { code: 'PN', name: 'Îles Pitcairn', dialCode: '+64' },
...
export const COUNTRY_DIAL_CODES = [...COUNTRY_DIAL_CODES_RAW].sort((a, b) =>
  a.name.localeCompare(b.name, 'fr', { sensitivity: 'base' })
);

export function findCountryByCode(code) {
  return COUNTRY_DIAL_CODES.find((country) => country.code === code) ?? COUNTRY_DIAL_CODES[0];
}
...
export function buildInternationalPhone(countryCode, localPhone) {
  const country = findCountryByCode(countryCode);
  return `${country.dialCode}${normalizePhoneDigits(localPhone)}`;
}
