...
// puppeteer-core est importé dynamiquement dans renderSpaHtml() pour éviter de faire
// crasher l'initialisation du module sur Vercel quand le renderer est désactivé
// (DISABLE_SPA_RENDERER=1) ou quand le bundle Chromium dépasse la limite de 50 MB.
// Un import statique ici ferait échouer le cold start de api/scan.js avec FUNCTION_INVOCATION_FAILED.
...
export async function renderSpaHtml(url) {
    ...
    try {
        // Import dynamique : évite de charger puppeteer-core au cold start
        // quand DISABLE_SPA_RENDERER=1 ou si le bundle Chromium est absent.
