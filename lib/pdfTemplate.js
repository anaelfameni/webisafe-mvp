...
function pageHeader(model, title, pageNumber) {
  return `<header class="page-header">${brand()}<p>${h(title)} · ${h(model.domain)}</p></header><footer class="page-footer"><p>${h(model.report.confidentiality)} · ${h(model.report.id)} · ${h(model.report.brandUrl)}</p><p>Page ${pageNumber} / ${model.report.totalPages}</p></footer>`;
}
